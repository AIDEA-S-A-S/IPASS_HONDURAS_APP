...
export default {
  light: {
    text: '#000',
    containerText: '#EDEDED',
    background: '#fff',
    tint: '#E46600',
    tintActive: '#E46600',
    tinteInactive: '#6D6D6D',
    tabIconDefault: '#ccc',
    tabIconSelected: tintColorLight,
    gradientTartetMenu: ['#E46600', '#AF0B4D'],
    gradientItemList: [],
    tintButton: tintColorDark,
    blueAdmin: 'rgba(63,203,226,1)',
    backgroundLoading: 'rgba(200,199,199,0.8)',
    backgrounItemList: 'rgba(255,255,255,1)',
    backgroundModal: '#F1F1F1',
    borderColor: '#000',
    'color-primary-100': '#FF8623',
    'color-primary-200': '#FF8623',
    'color-primary-300': '#FF8623',
    'color-primary-400': '#FFC391',
    //Color focus item && Color background button
    'color-primary-500': '#FF8623',
    'color-primary-600': '#FF8623',
    'color-primary-700': '#FF8623',
    'color-primary-800': '#FF8623',
    'color-primary-900': '#FF8623',
    'color-primary-transparent-100': 'rgba(39, 39, 39, 0.5)',
    'color-primary-transparent-200': 'rgba(255, 134, 35, 0.16)',
    'color-primary-transparent-300': 'rgba(255, 134, 35, 0.24)',
    'color-primary-transparent-400': 'rgba(255, 134, 35, 0.32)',
    'color-primary-transparent-500': 'rgba(255, 134, 35, 0.40)',
    'color-primary-transparent-600': 'rgba(255, 134, 35, 0.48)',
    'color-success-100': '#00C22A',
    'color-success-200': '#00C22A',
    'color-success-300': '#00C22A',
    'color-success-400': '#00C22A',
    'color-success-500': '#00C22A',
    'color-success-600': '#00C22A',
    'color-success-700': '#00C22A',
    'color-success-800': '#00C22A',
    'color-success-900': '#00C22A',
    ...
    'color-info-100': '#FF8623',
    'color-info-200': '#FF8623',
    'color-info-300': '#FF8623',
    'color-info-400': '#FF8623',
    'color-info-500': '#FF8623',
    'color-info-600': '#FF8623',
    'color-info-700': '#FF8623',
    'color-info-800': '#FF8623',
    'color-info-900': '#FF8623',
    ...
    'color-warning-100': '#FF8623',
    'color-warning-200': '#FF8623',
    'color-warning-300': '#FF8623',
    'color-warning-400': '#FF8623',
    'color-warning-500': '#FF8623',
    'color-warning-600': '#FF8623',
    'color-warning-700': '#FF8623',
    'color-warning-800': '#FF8623',
    'color-warning-900': '#FF8623',
    ...
    'color-danger-100': '#D00505',
    'color-danger-200': '#D00505',
    'color-danger-300': '#D00505',
    'color-danger-400': '#D00505',
    'color-danger-500': '#D00505',
    'color-danger-600': '#D00505',
    'color-danger-700': '#D00505',
    'color-danger-800': '#D00505',
    'color-danger-900': '#D00505',
    ...
    //Color texto (input && button)
    'color-basic-100': '#FDF3EB',
    //Color background (input)
    'color-basic-200': '#FDF3EB',
    'color-basic-300': '#000000',
    //Color background border (input)
    'color-basic-400': 'transparent',
    'color-basic-500': '#FF8623',
    // Color iconos (input)
    'color-basic-600': '#000000',
    'color-basic-700': '#FF8623',
    //Color background (input) seleccionado
    'color-basic-800': '#272727',
    'color-basic-900': '#FDF3EB',
    'color-basic-1000': '#000001',
    'color-basic-1100': '#000002',
    ...
    'color-basic-transparent-300': 'rgba(228, 102, 0, 0.24)',
  ...
  dark: {
    text: '#fff',
    background: '#000',
    containerText: '#242424',
    tint: '#E46600',
    tintActive: '#FF8623',
    tinteInactive: '#EDEDED',
    tabIconDefault: '#ccc',
    ...
    tintButton: tintColorDark,
    blueAdmin: 'rgba(63,203,226,1)',
    backgroundLoading: 'rgba(60,60,60,0.8)',
    backgrounItemList: 'rgba(255,255,255,0.1)',
    ...
    'color-primary-transparent-500': 'rgba(255, 134, 35, 0.40)',
    'color-primary-transparent-600': 'rgba(255, 134, 35, 0.48)',
    'color-success-100': '#00771A',
    'color-success-200': '#00771A',
    'color-success-300': '#00771A',
    'color-success-400': '#00771A',
    'color-success-500': '#00771A',
    'color-success-600': '#00771A',
    'color-success-700': '#00771A',
    'color-success-800': '#00771A',
    'color-success-900': '#00771A',
    'color-success-transparent-100': 'rgba(0, 224, 150, 0.08)',
    'color-success-transparent-200': 'rgba(0, 224, 150, 0.16)',
    'color-success-transparent-300': 'rgba(0, 224, 150, 0.24)',
    'color-success-transparent-400': 'rgba(0, 224, 150, 0.32)',
    ...
    'color-warning-transparent-500': 'rgba(255, 170, 0, 0.40)',
    'color-warning-transparent-600': 'rgba(255, 170, 0, 0.48)',
    'color-danger-100': '#A00404',
    'color-danger-200': '#A00404',
    'color-danger-300': '#A00404',
    'color-danger-400': '#A00404',
    'color-danger-500': '#A00404',
    'color-danger-600': '#A00404',
    'color-danger-700': '#A00404',
    'color-danger-800': '#A00404',
    'color-danger-900': '#A00404',
    'color-danger-transparent-100': 'rgba(255, 61, 113, 0.08)',
    'color-danger-transparent-200': 'rgba(255, 61, 113, 0.16)',
    'color-danger-transparent-300': 'rgba(255, 61, 113, 0.24)',
    'color-danger-transparent-400': 'rgba(255, 61, 113, 0.32)',
    ...
    'color-basic-200': '#000000',
    'color-basic-300': '#000000',
    'color-basic-400': '#000000',
    'color-basic-500': '#000000',
    // Color iconos (input)
    'color-basic-600': '#FFFFFF',
    'color-basic-700': '#000000',
    //Color background (input) seleccionado
    'color-basic-800': '#272727',
    //Color background (input)
    'color-basic-900': '#272727',
